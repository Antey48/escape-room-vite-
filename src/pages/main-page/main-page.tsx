import FilterLevelList from '../../components/filter-level/filter-level';
import Header from '../../components/header/header';
import { DEFAULT_ACTIVE_LEVELS, LEVELS, PageName } from '../../constants';
import MainEmptyPage from '../main-empty-page/main-empty-page';


function MainPage(): JSX.Element {
  const questCount = 5;
  const currentLevel = DEFAULT_ACTIVE_LEVELS;
  const handleCurrentLevelChange = ():void =>{
